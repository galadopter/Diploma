...
\vspace{0.5em}
\begin{flalign*}
\hspace{1.3cm}\subSalary&=\frac{10493,56*10}{100}=1049,36\:\BYN &
\end{flalign*}
...
\vspace{0.5em}
\begin{flalign*}
\hspace{1.3cm}\ssfCharges&=\frac{(10493,56+1049,36)*34,6}{100}=3993,85\:\BYN &
\end{flalign*}
...
\begin{flalign*}
\hspace{1.3cm}\overheadCosts&=\frac{10493,56*50}{100}=5246,78\:\BYN &
\end{flalign*}
...
\begin{flalign*}
\hspace{1.3cm}\stabilizationCosts&=\frac{23183,55*20}{100}=4636,71\:\BYN &
\end{flalign*}
...
\vspace{0.3em}
\begin{flalign*}
\hspace{1.3cm}\realizationCharges&=\frac{27820,26*5}{100}=1391,01\:\BYN &
\end{flalign*}

Общие затраты на разработку и реализацию программного средства:
\begin{flalign*}
\hspace{1.3cm}\text{З}&=\totalCharges+\realizationCharges=27820,26+1391,01=29211,27\:\BYN &
\end{flalign*}
...
\vspace{0.5em}
\begin{flalign*}
\hspace{1.3cm}\realizationProfit&=\frac{27820,26*25}{100}=6955,07\:\BYN &
\end{flalign*}
\vspace{0.1em}
...
\vspace{0.5em}
\begin{flalign*}
\hspace{1.3cm}\incomeForOne&=170-\frac{27820,26+1391,01}{550}=116,89\:\BYN &
\end{flalign*}
...
\begin{flalign*}
\hspace{1.3cm}\incomeForYear{2019}&=116,89*100=11689\:\BYN &\\
\hspace{1.3cm}\incomeForYear{2020}&=116,89*200=23378\:\BYN &\\
\hspace{1.3cm}\incomeForYear{2021}&=116,89*200=23378\:\BYN &\\
\hspace{1.3cm}\incomeForYear{2022}&=116,89*250=29222,50\:\BYN &
\end{flalign*}
...
\begin{flalign*}
\hspace{1.3cm}\clearIncomeForYear{2019}&=11689-\frac{11689*12}{100}=10286,32\:\BYN &\\
\hspace{1.3cm}\clearIncomeForYear{2020}&=20572,64\:\BYN &\\
\hspace{1.3cm}\clearIncomeForYear{2021}&=20572,64\:\BYN &\\
\hspace{1.3cm}\clearIncomeForYear{2022}&=25715,80\:\BYN &
\end{flalign*}
...
\begin{flalign*}
\hspace{1.3cm}\discontCoefficientForYear{1}&=\frac{1}{(1+0,105)^{0}}=1 &\\
\hspace{1.3cm}\discontCoefficientForYear{2}&=\frac{1}{(1+0,105)^{1}}=0,90 &\\
\hspace{1.3cm}\discontCoefficientForYear{3}&=\frac{1}{(1+0,105)^{2}}=0,82 &\\
\hspace{1.3cm}\discontCoefficientForYear{4}&=\frac{1}{(1+0,105)^{3}}=0,74 &
\end{flalign*}
...
\begin{flalign*}
\hspace{1.3cm}\averageIncome&=\frac{5143,16+20572,64+20572,64+25715,80}{4}=14143,69\:\BYN &
\end{flalign*}
...
\begin{flalign*}
\hspace{1.3cm}\investmentProfitability&=\frac{14143,69}{27820,26}=51\% &
\end{flalign*}
